...
/*
 * Function pointer types to the extended functions we
 * load and inject into the original Warcraft 3 renderer.
 */
...
typedef void            (GLPROXY_DECL * pfn_glPopClientAttrib)           (void);
typedef const GLubyte * (GLPROXY_DECL * pfn_glGetString)                 (GLenum name);
typedef GLenum          (GLPROXY_DECL * pfn_glGetError)                  (void);
typedef void            (GLPROXY_DECL * pfn_glGetIntegerv)               (GLenum pname, GLint * data);
typedef void            (GLPROXY_DECL * pfn_glViewport)                  (GLint x, GLint y, GLsizei width, GLsizei height);
typedef void            (GLPROXY_DECL * pfn_glReadBuffer)                (GLenum src);
typedef void            (GLPROXY_DECL * pfn_glReadPixels)                (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void * pixels);
typedef GLuint          (GLPROXY_DECL * pfn_glCreateProgram)             (void);
typedef GLuint          (GLPROXY_DECL * pfn_glCreateShader)              (GLenum type);
typedef void            (GLPROXY_DECL * pfn_glAttachShader)              (GLuint program, GLuint shader);
typedef void            (GLPROXY_DECL * pfn_glCompileShader)             (GLuint shader);
typedef void            (GLPROXY_DECL * pfn_glDeleteProgram)             (GLuint program);
...
typedef void            (GLPROXY_DECL * pfn_glGetShaderInfoLog)          (GLuint shader, GLsizei bufSize, GLsizei * length, GLchar * infoLog);
typedef void            (GLPROXY_DECL * pfn_glGetProgramiv)              (GLuint program, GLenum pname, GLint * params);
typedef void            (GLPROXY_DECL * pfn_glGetShaderiv)               (GLuint shader, GLenum pname, GLint * params);
typedef GLint           (GLPROXY_DECL * pfn_glGetUniformLocation)        (GLuint program, const GLchar * name);
typedef void            (GLPROXY_DECL * pfn_glUniform1f)                 (GLint location, GLfloat v0);
typedef void            (GLPROXY_DECL * pfn_glUniform2f)                 (GLint location, GLfloat v0, GLfloat v1);
typedef void            (GLPROXY_DECL * pfn_glUniform3f)                 (GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
typedef void            (GLPROXY_DECL * pfn_glUniform4f)                 (GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
typedef void            (GLPROXY_DECL * pfn_glUniform1i)                 (GLint location, GLint v0);
typedef void            (GLPROXY_DECL * pfn_glUniform2i)                 (GLint location, GLint v0, GLint v1);
typedef void            (GLPROXY_DECL * pfn_glUniform3i)                 (GLint location, GLint v0, GLint v1, GLint v2);
...
typedef void            (GLPROXY_DECL * pfn_glGetTexImage)               (GLenum target, GLint level, GLenum format, GLenum type, void * pixels);
typedef void            (GLPROXY_DECL * pfn_glGenerateMipmap)            (GLenum target);
typedef GLboolean       (GLPROXY_DECL * pfn_glIsFramebuffer)             (GLuint framebuffer);
typedef void            (GLPROXY_DECL * pfn_glBindFramebuffer)           (GLenum target, GLuint framebuffer);
typedef void            (GLPROXY_DECL * pfn_glDeleteFramebuffers)        (GLsizei n, const GLuint * framebuffers);
typedef void            (GLPROXY_DECL * pfn_glGenFramebuffers)           (GLsizei n, GLuint * framebuffers);
typedef GLenum          (GLPROXY_DECL * pfn_glCheckFramebufferStatus)    (GLenum target);
typedef void            (GLPROXY_DECL * pfn_glFramebufferTexture2D)      (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
typedef void            (GLPROXY_DECL * pfn_glBlitFramebuffer)           (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
...
typedef void            (GLPROXY_DECL * pfn_glBufferData)                (GLenum target, GLsizei size, const void * data, GLenum usage);
typedef void            (GLPROXY_DECL * pfn_glBufferSubData)             (GLenum target, GLsizei offset, GLsizei size, const void * data);
typedef void            (GLPROXY_DECL * pfn_glDrawArrays)                (GLenum mode, GLint first, GLsizei count);
typedef void            (GLPROXY_DECL * pfn_glDrawElements)              (GLenum mode, GLsizei count, GLenum type, const void * indices);
typedef void            (GLPROXY_DECL * pfn_glEnableClientState)         (GLenum array);
typedef void            (GLPROXY_DECL * pfn_glDisableClientState)        (GLenum array);
typedef void            (GLPROXY_DECL * pfn_glVertexPointer)             (GLint size, GLenum type, GLsizei stride, const void * pointer);
typedef void            (GLPROXY_DECL * pfn_glColorPointer)              (GLint size, GLenum type, GLsizei stride, const void * pointer);
typedef void            (GLPROXY_DECL * pfn_glTexCoordPointer)           (GLint size, GLenum type, GLsizei stride, const void * pointer);
typedef void            (GLPROXY_DECL * pfn_glNormalPointer)             (GLenum type, GLsizei stride, const void * pointer);
